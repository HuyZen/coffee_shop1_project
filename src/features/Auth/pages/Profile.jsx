    ...
    return (
        <div className='col l-6 l-o-3 mt-[60px] mb-10'>
            <div className='mx-auto text-center w-[30%]'>
                ...
                <button onClick={handleChangeAvt} className='w-full h-8 text-white bg-black'>Change your profile</button>
                {
                    show && (
            ...
            <div className='ml-5'>
                ...
                <button className='mt-4 w-20 h-8 text-white bg-red-600' onClick={handleLogout}>Log Out</button>
            </div>
            <ToastContainer />
        </div>
